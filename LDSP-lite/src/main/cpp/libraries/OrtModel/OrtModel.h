#ifndef LDSP_LITE_LDSP_LITE_SRC_MAIN_CPP_LIBRARIES_ORTMODEL_ORTMODEL_H_
#define LDSP_LITE_LDSP_LITE_SRC_MAIN_CPP_LIBRARIES_ORTMODEL_ORTMODEL_H_
...
#endif //LDSP_LITE_LDSP_LITE_SRC_MAIN_CPP_LIBRARIES_ORTMODEL_ORTMODEL_H_
