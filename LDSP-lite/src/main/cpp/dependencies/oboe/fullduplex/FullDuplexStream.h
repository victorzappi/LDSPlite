// This code is based on AOSP's Oboe library credited below,
// but it has been modified by Victor Zappi
...
public:
    ...
    virtual oboe::DataCallbackResult onBothStreamsReady(
            /*const*/ float *inputData, //VIC const is reintroduced in LDSP context
            int   numInputFrames,
            float *outputData,
            int   numOutputFrames
            ) = 0;
