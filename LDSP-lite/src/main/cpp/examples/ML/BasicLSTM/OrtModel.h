...
//    void run();
//    void run(float inputTensorData[1][1], float * outputTensorData);
    std::vector<float> run(std::vector<std::vector<float>> inputs);
    void run(std::vector<std::vector<float>> inputs, float * output);
    std::vector<std::vector<float>> randInputs();
